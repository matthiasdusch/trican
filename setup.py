...
URL = 'https://github.com/matthiasdusch/trican'
CLASSIFIERS = [
...
DESCRIPTION = 'Tree Ring Chronology Altitude Normalization'
LONG_DESCRIPTION = """
Altitude corrections of tree ring data.
"""
...
if not ISRELEASED:
    ...
    if pipe is None or pipe.returncode != 0:
        ...
        if path.exists('trican/version.py'):
...
"""
    if not filename:
        filename = path.join(path.dirname(__file__), 'trican', 'version.py')
